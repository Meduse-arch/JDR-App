...
## Project Overview
This is **jdr-app**, a desktop application designed to manage role-playing game (JDR) sessions, characters, inventories, and skills. It features a multi-role system (Admin, MJ, Joueur) and provides real-time updates through Supabase.
