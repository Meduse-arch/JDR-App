  ...
  return (
    <div className="h-full overflow-y-auto custom-scrollbar px-6 py-5">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        ...
        {isMJ && (
          <div onClick={onCreateClick} className="rounded-lg border border-dashed border-[rgba(200,168,75,0.15)] bg-[rgba(200,168,75,0.02)] cursor-pointer flex flex-col items-center justify-center gap-2 hover:bg-[rgba(200,168,75,0.05)] transition-all" style={{ aspectRatio: '4/3' }}>
